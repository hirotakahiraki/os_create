...
void HariMain(void)
{
	...
	sprintf(s, "memory %dMB  free : %dKB, %d, %d", memtotal/(1024 *1024), memman_total(memman)/1024,binfo->scrnx, binfo->scrny);
	putfonts8_asc(buf_back, binfo->scrnx, 0, 32, COL8_FFFFFF, s);
/*	sprintf(s, "hogehoge");
	putfonts8_asc(buf_back, binfo->scrnx, 314, 100, COL8_FFFFFF, s);
